...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   channelCmdsUtilsJoin.cpp                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: llacsivy <llacsivy@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/26 17:46:23 by llacsivy          #+#    #+#             */
/*   Updated: 2025/04/26 17:46:24 by llacsivy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void handleNewChannel(IServer& server, IChannel*& channel, \
	const std::string& channelName, const std::string& password, IClient& client)
{
